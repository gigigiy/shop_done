...
import com.example.demo4.Cart.ShoppingCart;
import com.example.demo4.home.HomeController;
...
public class HomeController {
    ...
    public void initialize() throws FileNotFoundException {
        ...
        VBox productView3 = productView(Product.LETTUCE);
        productGridPane.add(productView3,2,0);

        VBox productView4 = productView(Product.JUICE);
